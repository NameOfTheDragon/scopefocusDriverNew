...
namespace ASCOM.scopefocus6
{
    ...
    public partial class Focuser : IFocuserV2
    {
        ...
        /// </summary>
        /// <remarks>
        ///     The id and description parameters are passed in from the default public constructor, which is defined
        ///     in another part of the partial class. This is done to let multiple copies of the code
        ///     compile with different device ID and description.
        /// </remarks>
        private Focuser(string id, string description)
            {
            this.driverID = id;
...
#region Common properties and methods.
        ...
        public void SetupDialog()
        {
            ...
            using (SetupDialogForm F = new SetupDialogForm(driverID, driverDescription))
            {
            ...
            set
            {
                ...
                if (value)
                {
                    ...
                    using (ASCOM.Utilities.Profile p = new Profile())
                    {
                        ...
                        focuserSteps = Convert.ToInt32(p.GetValue(driverID, "MaxPos"));
...
#region ASCOM Registration
        ...
        private static void RegUnregASCOM(bool bRegister)
        {
            using (var P = new ASCOM.Utilities.Profile())
            {
                ...
                if (bRegister)
                {
                    P.Register(Focuser.InstanceId, Focuser.InstanceDescription);
                }
                else
                {
                    P.Unregister(Focuser.InstanceId);
                }
            }
        }
